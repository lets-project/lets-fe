    ...
    return (
        <div className="settingMain">
            ...
            <form>
                ...
                <button className="settingButtonSignOut" onClick={handleShow} name="signOut">
                    회원탈퇴
                </button>
                ...
                <button
                    ...
                    onClick={() => {
                        ...
                        axios
                            .get('https://lets-team-project.herokuapp.com/api/users/setting', {
                                headers: {
                                    Authorization:
                                        'Bearer eyJyb2xlIjoiUk9MRV9VU0VSIiwiYWxnIjoiSFM1MTIifQ.eyJzdWIiOiIyIiwiaWF0IjoxNjQ0ODIyMDMyLCJleHAiOjE2NDQ4MjM4MzJ9.AzFz8DCiGNARmLVzikgQzGppaZtjFU4I8yagTFdFRbdhKmwaFv_Ue90JrJGRkluKD0ycFKbdPdzWrFJPFIq3cQ',
                                },
...
function Popup(props) {
    return (
        <div className="popupDiv">
            <Modal {...props} size="lg" centered show={props.show} onHide={props.handleClose}>
                <div className="cancelButtonWrapper">
                    <Modal.Body>
                        <div className="bodyTitle">Hola에서 계정을 삭제하시겠어요?</div>
                        <section className="CancelButtonButtons">
                            <div>
                                <button className="CancelButtonCancelButton" onClick={props.handleClose}>
                                    아니요
                                </button>
                                <button className="CancelButtonRegisterButton">네, 삭제할래요</button>
                            </div>
                        </section>
                    </Modal.Body>
                </div>
